...
const YEMEK_FOTO_ESLEME = [
  [['Gyoza'], ['asya-gyoza', 'asya-hargow', 'manti', 'asya-baozi']],
  [['Ramen', 'Tonkotsu', 'Udon', 'Soba', 'Japanese Noodles'],
    ['asya-ramen', 'ramen', 'asya-eriste']],
  [['Sushi', 'Kaiseki'],
    ['asya-sushi-tabak', 'sushi', 'nigiri', 'asya-tataki', 'meze-tartar']],
  [['Izakaya', 'Yakitori'],
    ['asya-yakitori', 'asya-gyoza', 'asya-tempura', 'et-kusbasi', 'ramen']],
  ...
  [['Asian Fusion', 'Chinese', 'Thai-Chinese', 'Vietnamese'],
    ['asya-pekin-ordek', 'asya-mapo', 'asya-baozi', 'asya-hargow', 'asya-pilav',
     'manti', 'sef-kaburga']],
  [['New American', 'Contemporary American', 'Californian'],
    ['biftek-fine', 'tarak', 'somon', 'sef-kaburga', 'meze-tarak']],
  [['Casual'], ['burger', 'asya-pilav', 'asya-eriste']],
